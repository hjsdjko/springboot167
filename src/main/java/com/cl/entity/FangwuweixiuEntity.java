...
public class FangwuweixiuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public FangwuweixiuEntity() {
		
	}
	
	public FangwuweixiuEntity(T t) {
		try {
	 ...
	 * 设置：损坏地方
	 */
	public void setSunhuaidifang(String sunhuaidifang) {
		this.sunhuaidifang = sunhuaidifang;
	}
	/**
	 * 获取：损坏地方
	 */
	public String getSunhuaidifang() {
		return sunhuaidifang;
	}
	/**
	 * 设置：申请内容
	 */
