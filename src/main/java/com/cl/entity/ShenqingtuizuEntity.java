...
public class ShenqingtuizuEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ShenqingtuizuEntity() {
		
	}
	
	public ShenqingtuizuEntity(T t) {
		try {
	 ...
	 * 设置：退租原因
	 */
	public void setTuizuyuanyin(String tuizuyuanyin) {
		this.tuizuyuanyin = tuizuyuanyin;
	}
	/**
	 * 获取：退租原因
	 */
	public String getTuizuyuanyin() {
		return tuizuyuanyin;
	}
	/**
	 * 设置：退租时间
